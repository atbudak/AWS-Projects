...
DATABASES = {
    'default': {
        ...
        'HOST': 'capstonedb.c5wnhkyubboa.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'capstone-blog-picture-videos' # please enter your s3 bucket name
